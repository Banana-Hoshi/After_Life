...
public class FMODAudioVisualizer : MonoBehaviour
{
    ...
    private void SpawnMeterObjects()
    {
        ...
        {
            bandMeters[i] = Instantiate(MeterObject, mainCanvas.transform.position, mainCanvas.transform.rotation, mainCanvas.transform);
            bandMeters[i].transform.position = new Vector3(960f, transform.position.y, 0f);
